...
#if !defined(INLINE)
#include "Mathutils.ih"
#endif
///////////////////////////////////////////////////////////////////////////////

using namespace std;

const char* const Mathutils_RCS_ID = "@(#)class Mathutils definition.";
 ...
 */
const float 
ImaGene::Mathutils::two_pi_f = (float) 2*M_PI;
 ...
 */
const double
ImaGene::Mathutils::two_pi_d = (double) 2*M_PI;
 ...
 */
float
ImaGene::Mathutils::angleMod( float angle )
{
 ...
 */
float 
ImaGene::Mathutils::angleAroundZero( float angle )
{
 ...
 */
float
ImaGene::Mathutils::tune( float angle_ref, float other_angle )
{
 ...
 */
bool 
ImaGene::Mathutils::less( float angle1, float angle2 )
{
 ...
 */
float
ImaGene::Mathutils::averagedLength( float t )
{
 ...
 */
unsigned int
ImaGene::Mathutils::random( unsigned int p )
{
 ...
 */
unsigned long long 
ImaGene::Mathutils::random( unsigned long long p )
{
  if ( p > 0xffffffffffffLL )
    {
      unsigned int p2 = ( (unsigned int) ( p >> 48 ) ) & 0xffffff;
      unsigned int q0 = ImaGene::Mathutils::random( (unsigned int) 0x1000000 );
      unsigned int q1 = ImaGene::Mathutils::random( (unsigned int) 0x1000000 );
      unsigned int q2 = ImaGene::Mathutils::random( p2 );
  ...
  else if ( p > 0xffffff )
    {
      ...
      unsigned int q0 = ImaGene::Mathutils::random( (unsigned int) 0x1000000 );
      unsigned int q1 = ImaGene::Mathutils::random( p1 );
      return (unsigned long long) q0
	+ ( ( (unsigned long long) q1 ) << 24 );
    }
  else
    {
      ...
      unsigned int q0 = ImaGene::Mathutils::random( p0 );
      return (unsigned long long) q0;
    }
}
 ...
 */
int
ImaGene::Mathutils::getMSBbyLog( unsigned long long v )
{
  register int i;
 ...
 */
int 
ImaGene::Mathutils::getMSB( unsigned long long v )
{
 ...
 */
unsigned long long
ImaGene::Mathutils::greaterPrime( unsigned long long n )
{
 ...
 */
void 
ImaGene::Mathutils::selfDisplay( ostream& that_stream ) const
{
